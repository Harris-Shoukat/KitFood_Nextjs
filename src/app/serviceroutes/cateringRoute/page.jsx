    ...
    <>
      ...
      <div className="relative">
        ...
        <h1 className="absolute top-20 left-[6%] text-4xl italic text-white">
          ...
          <span className="text-black">{` > Service traiteur`}</span>
        </h1>
      ...
      <div className="max-w-[90%] mx-auto mt-8">
        <form className="space-y-8 bg-white p-8 rounded-lg ">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
            ...
            <div>
              <label htmlFor="eventType" className="block text-xl font-semibold text-gray-700">
                Type of Event
              </label>
              <select
                id="eventType"
